  ...
  const projects = [
    {
      title: "Gacha World",
      description:
        "Collaborative university project developing a gacha-based game featuring account management, registration, and authentication.",
      details: [
    ...
    },
    {
      title: "SpeedyGuesser",
      description:
        "Developed a multiplayer game where two players assist a third in guessing words, with account management and matchmaking.",
      details: [
    ...
    },
    {
      title: "Hotelier",
      description:
        "Hotel review system inspired by TripAdvisor capable of managing users, hotels, reviews, and city rankings.",
      details: [
    ...
    },
    {
      ...
      description:
        "Text-based adventure game with interactive user interface and client-server architecture.",
      details: [
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <a
                      ...
                      className="text-main hover:text-second">
